...
/* harmony export */ });
/* harmony import */ var _editor_editor_api_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6801);
...
var LibFiles = class {
  ...
  getOrCreateModel(fileName) {
    ...
    const matchedLibFile = _monaco_contribution_js__WEBPACK_IMPORTED_MODULE_1__/* .typescriptDefaults */ .TG.getExtraLibs()[fileName];
    if (matchedLibFile) {
